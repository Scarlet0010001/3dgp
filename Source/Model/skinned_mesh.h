...
public:
    ...
    struct vertex
    {
        ...
        void serialize(T& archive)
        {
            ...
            //archive(texcoord, bone_weights, bone_indices);
        }
    };
    ...
    struct mesh
    {
        ...
        struct subset
        {
            ...
            void serialize(T& archive)
            {
                archive(material_unique_id, material_name,
        ...
        void serialize(T& archive)
        {
            ...
            //archive(unique_id, name, node_index, subsets, default_global_transform, bind_pose, indices);
        }
    ...
    struct material
    {
        ...
        void serialize(T& archive)
        {
            ...
            //archive(unique_id, name, texture_filenames);
        }
    };
...
private:
    ...
    void skinned_mesh::fetch_skeleton(FbxMesh* fbx_mesh,
        skeleton& bind_pose);

    void skinned_mesh::fetch_animations(FbxScene* fbx_scene, std::vector<animation>& animation_clips,
        float sampling_rate 
    /*If this value is 0, the animation data
    will be sampled at the default frame rate.*/);
