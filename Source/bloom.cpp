...
bloom::bloom(ID3D11Device* device, uint32_t width, uint32_t height) : fullscreen_quad(device)
{
	...
	glow_extraction_ps = shader<ID3D11PixelShader>::_emplace(device, "Shader/glow_extraction_ps.cso");
	gaussian_blur_horizontal_ps = shader<ID3D11PixelShader>::_emplace(device, "Shader/gaussian_blur_horizontal_ps.cso");
	gaussian_blur_vertical_ps = shader<ID3D11PixelShader>::_emplace(device, "Shader/gaussian_blur_vertical_ps.cso");
	gaussian_blur_upsampling_ps = shader<ID3D11PixelShader>::_emplace(device, "Shader/gaussian_blur_upsampling_ps.cso");
	gaussian_blur_downsampling_ps = shader<ID3D11PixelShader>::_emplace(device, "Shader/gaussian_blur_downsampling_ps.cso");
}
