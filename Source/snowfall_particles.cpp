...
snowfall_particles::snowfall_particles(ID3D11Device* device, DirectX::XMFLOAT4 initial_position)
{
	...
	vertex_shader = shader<ID3D11VertexShader>::_emplace(device, "Shader/snowfall_particles_vs.cso", NULL, NULL, 0);
	geometry_shader = shader<ID3D11GeometryShader>::_emplace(device, "Shader/snowfall_particles_gs.cso");
	compute_shader = shader<ID3D11ComputeShader>::_emplace(device, "Shader/snowfall_particles_cs.cso");
	pixel_shader = shader<ID3D11PixelShader>::_emplace(device, "Shader/snowfall_particles_ps.cso");
